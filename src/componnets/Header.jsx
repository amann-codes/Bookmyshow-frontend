                ...
                <div className='flex justify-between items-center h-full w-full'>
                  ...
                  <div className='flex justify-end items-center h-full'>
                    ...
                    <div className='flex justify-between items-center'>
                      <div className='bg-[#F84464] rounded text-center text-xs  w-[67px] h-[25px]  leading-6 text-white cursor-pointer'>Sign in</div>
                        <div className='ml-6'><svg width="22px" height="14px" xmlns="http://www.w3.org/2000/svg"><title>Hamburger Menu</title><g fillRule="nonzero" stroke="#3B4261" strokwidth="1.5" fill="none" strokeLinecap="round"><path d="M1.611 1h20.614M1.611 7h20.614M1.611 13h20.614"></path></g></svg></div>
                    </div>
                  </div>
                </div>
              </div>
